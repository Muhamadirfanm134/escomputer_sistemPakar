                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                          ...
                          <div class="x_content">
                              ...
                              <div class="row mt-3">
                                  <div class="col-md-6">
                                      <a href="" class="btn btn-round btn-primary" data-toggle="modal"
                                          data-target="#tambahKerusakan">Tambah Data Kerusakan</a>
                                  </div>
                              </div>
                              ...
                              <table id="datatable" class="table table-striped table-bordered">
                                  ...
                                  <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td><img src="<?= base_url('assets/images/kerusakan/') . $rusak['gambar']; ?>"
                                                  width="150"></td>
                                          <td><?= $rusak['solusi']; ?></td>
                                          <td>
                                              <a href="<?= base_url('kerusakan/hapus/') . $rusak['id_kerusakan']; ?>"
                                                  class="btn btn-danger btn-sm"
                                                  onclick="return confirm('Data akan dihapus');">Hapus</a>
                                              <a href="" class="btn btn-warning btn-sm" data-toggle="modal"
                                                  data-target=".ubahKerusakan<?= $rusak['id_kerusakan']; ?>">Ubah</a>
                                          </td>
                                      </tr>
                                      <?php $i++; ?>
                                      <?php endforeach; ?>
